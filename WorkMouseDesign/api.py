...
def WorkMouseDesignApi():
    ...
    pet.register_state(
        "idle",
        image_path=SourceDataDir + "pony-town-NyanLuna-fly-4x-left.gif",
    ...
    pet.register_state(
        "move_right",
        image_path=SourceDataDir + "pony-town-NyanLuna-fly-4x-right.gif",
        size=(100, 100),
        offset=(-120, 35),
    )
    ...
    pet.register_state(
        "sleep",
        image_path=SourceDataDir + "pony-town-NyanLuna-yawn-4x.gif",
        size=(100, 100),
        offset=(0, 40),
    )
    ...
    pet.register_state(
        "bored",
        image_path=SourceDataDir + "pony-town-NyanLuna-trot-4x.gif",
        size=(100, 100),
        offset=(0, 35),
    )
